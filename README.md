...
- **Interview date tracker** — Set a per-mode interview date to anchor urgency, include date context in exported briefs, and download an `.ics` calendar plan with prep checkpoints.
