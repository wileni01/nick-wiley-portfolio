...
- **Contact API hardening** — Contact submissions use schema validation, honeypot filtering, rate limiting, input sanitization, minimal metadata-only logging (no raw body previews), and optional Resend delivery with failure handling.
